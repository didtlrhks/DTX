...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_31.dart';

class DietSurveyPage30 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage30({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text(
                          '30. 달달한 음료수(콜라 또는 사이다 등의 탄산음료, 믹스커피, 시럽 넣은 커피, 식혜, 매실차 등)를 얼마나 자주 드십니까?',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ30Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ30Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ30Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage31()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
