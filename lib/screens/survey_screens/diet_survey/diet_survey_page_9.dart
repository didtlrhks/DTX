...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_10.dart';

class DietSurveyPage9 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage9({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('9. 배가 불러 그만두고 싶은데 계속 드시는 경우가 있습니까? ',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ9Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ9Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ9Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage10()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
