...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_8.dart';

class DietSurveyPage7 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage7({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text(
                          '7. 식사 전에 간식을 드셔서 식사를 드시기 어려운 경우가 얼마나 자주 있습니까?',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ7Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ7Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ7Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage8()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
