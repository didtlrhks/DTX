...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_34.dart';

class DietSurveyPage33 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage33({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('33. 편의점 음식으로 한 끼 식사를 대신 하는 경우가 얼마나 자주 있습니까? ',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ33Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ33Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ33Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage34()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
