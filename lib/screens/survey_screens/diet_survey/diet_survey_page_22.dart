...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_23.dart';

class DietSurveyPage22 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage22({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('22. 채소류(생채소, 나물, 샐러드)를 얼마나 자주 드십니까?(김치 제외)',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ22Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ22Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ22Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage23()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
