...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_40.dart';

class DietSurveyPage39 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage39({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text(
                          '39. 판매하는 반찬(양념된 고기, 조림, 장아찌, 젓갈, 게장류 등)을 얼마나 자주 사서 드십니까? ',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ39Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ39Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ39Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage40()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
