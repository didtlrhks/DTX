...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_39.dart';

class DietSurveyPage38 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage38({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text(
                          '38. 음식(생선회, 전, 튀김류, 쌈류)섭취 시 간장, 쌈장, 고추장 등 소스를 듬뿍 찍어드십니까? ',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ38Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ38Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ38Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage39()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
