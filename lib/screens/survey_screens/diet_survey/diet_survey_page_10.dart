...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_11.dart';

class DietSurveyPage10 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage10({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('10. 스트레스를 받을 때 음식으로 푸는 편입니까? ',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ10Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ10Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ10Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage11()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
