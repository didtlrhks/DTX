...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_24.dart';

class DietSurveyPage23 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage23({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('23. 유제품(우유, 치즈, 플레인요거트, 발효유)를 얼마나 자주 드십니까?',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ23Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ23Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ23Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage24()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
