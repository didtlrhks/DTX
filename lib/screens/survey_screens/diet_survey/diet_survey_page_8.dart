...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_9.dart';

class DietSurveyPage8 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage8({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('8. 계획했던 것보다 많은 음식을 드시는 경우(과식)가 얼마나 자주 있습니까? ',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ8Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ8Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ8Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage9()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
