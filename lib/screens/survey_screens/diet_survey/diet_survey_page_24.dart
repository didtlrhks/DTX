...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_25.dart';

class DietSurveyPage24 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage24({super.key});
    ...
    return Scaffold(
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ24Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ24Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ24Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage25()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
