...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_5.dart';

class DietSurveyPage4 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage4({super.key});
    ...
    return Scaffold(
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ4Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ4Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ4Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage5()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
