...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_19.dart';

class DietSurveyPage18 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage18({super.key});
    ...
    return Scaffold(
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ18Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ18Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ18Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage19()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
