...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_26.dart';

class DietSurveyPage25 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage25({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('25. 전곡이나 잡곡류 (현미밥, 잡곡밥, 통밀빵 등)을 얼마나 자주 드십니까?',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ25Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ25Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ25Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage26()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
