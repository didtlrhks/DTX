...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_4.dart';

class DietSurveyPage3 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage3({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('3. 배달음식을 포함하여 외식을 얼마나 자주 드십니까?(학교, 회사 급식 제외)',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ3Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ3Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ3Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage4()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
