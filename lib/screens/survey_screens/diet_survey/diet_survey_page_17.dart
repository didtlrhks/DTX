...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_18.dart';

class DietSurveyPage17 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage17({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text(
                          '17. 육류(소고기,돼지고기, 닭고기, 양고기 등) 식품을 얼마나 자주 드십니까?',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ17Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ17Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ17Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage18()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
