...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_29.dart';

class DietSurveyPage28 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage28({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text(
                          '28. 튀긴 간식(도넛, 꽈배기, 호떡, 핫도그, 마가린을 이용한 식품), 과자(감자칩, 크래커, 팝콘 등)를 얼마나 자주 드십니까? ',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ28Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ28Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ28Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage29()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
