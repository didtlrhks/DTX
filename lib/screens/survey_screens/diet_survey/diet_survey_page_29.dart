...
import 'package:dtxproject/screens/survey_screens/diet_survey/diet_survey_page_30.dart';

class DietSurveyPage29 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  DietSurveyPage29({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text(
                          '29. 달달한 간식(초콜렛, 사탕, 마카롱, 케이크, 단팥빵, 브라우니, 머핀 등)을 얼마나 자주 드십니까?',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.dietQ29Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .dietQ29Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.dietQ29Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => DietSurveyPage30()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
