...
import 'package:dtxproject/screens/survey_screens/lifequality_survey/lifequality_survey_page_5.dart';

class LifeQualitySurveyPage4 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  LifeQualitySurveyPage4({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .LifeQualityQ4Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .LifeQualityQ4Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.LifeQualityQ4Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => LifeQualitySurveyPage5()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
