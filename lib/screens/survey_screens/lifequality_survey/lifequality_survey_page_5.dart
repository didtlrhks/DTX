...
import 'package:dtxproject/screens/survey_screens/lifequality_survey/lifequality_survey_page_6.dart';
import 'package:dtxproject/utils/survey_progress_bar_utils.dart';

class LifeQualitySurveyPage5 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  LifeQualitySurveyPage5({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .lifeQualityQ5Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .lifeQualityQ5Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.lifeQualityQ5Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => LifeQualitySurveyPage6()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
