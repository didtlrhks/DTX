...
class LifeQualitySurveyPage8 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  LifeQualitySurveyPage8({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(7.5),
                              color: Color(0xff4D4D4D), // 여덟 번째 진행 바 색상
                            ),
                          ),
                        ],
                      ),
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .LifeQualityQ8Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .LifeQualityQ8Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.LifeQualityQ8Option.value !=
