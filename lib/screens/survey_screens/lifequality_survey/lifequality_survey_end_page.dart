...
class LifeQualitySurveyEndPage extends StatelessWidget {
  const LifeQualitySurveyEndPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('생활 질 설문조사'),
        leading: IconButton(
          icon: const Icon(Icons.arrow_back),
          onPressed: () {
            Get.off(() => const LifeQualitySurveyStartPage());
          },
        ),
      ),
      body: SafeArea(
