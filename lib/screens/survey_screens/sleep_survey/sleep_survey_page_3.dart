...
import 'package:dtxproject/screens/survey_screens/sleep_survey/sleep_survey_page_4.dart';

class SleepSurveyPage3 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  SleepSurveyPage3({super.key});
    ...
    return Scaffold(
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.SleepQ3Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .SleepQ3Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.SleepQ3Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => SleepSurveyPage4()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
