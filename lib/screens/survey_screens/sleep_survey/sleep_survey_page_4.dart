...
import 'package:dtxproject/screens/survey_screens/sleep_survey/sleep_survey_page_5.dart';

class SleepSurveyPage4 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  SleepSurveyPage4({super.key});
    ...
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(7.5),
                              color: Color(0xff4D4D4D), // 네 번째 진행 바 색상
                            ),
                          ),
                          SizedBox(width: 4),
                          Container(
                      ...
                      SizedBox(height: 80),
                      const Text('4. 현재 수면패턴에 대해 얼마나 만족하고 계십니까?',
                          style:
                              ...
                              children: List.generate(5, (index) {
                                ...
                                return Obx(
                                  () {
                                    // 옵션 선택 확인
                                    bool isSelected =
                                        surveyController.SleepQ4Option.value ==
                                            index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .SleepQ4Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled =
            surveyController.SleepQ4Option.value != -1; // 선택된 옵션이 있어야 버튼 활성화됨.
        return Container(
          color: Colors.white,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => SleepSurveyPage5()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
