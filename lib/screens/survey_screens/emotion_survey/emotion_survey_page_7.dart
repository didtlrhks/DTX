...
import 'package:dtxproject/screens/survey_screens/emotion_survey/emotion_survey_page_8.dart';

class EmotionSurveyPage7 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  EmotionSurveyPage7({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('7. 신문을 읽거나 TV를 볼 때 집중하기 어려움',
                          style:
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .emotionQ7Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .emotionQ7Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.emotionQ7Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => EmotionSurveyPage8()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
