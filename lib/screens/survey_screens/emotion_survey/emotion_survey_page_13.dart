...
import 'package:dtxproject/screens/survey_screens/emotion_survey/emotion_survey_page_14.dart';

class EmotionSurveyPage13 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  EmotionSurveyPage13({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('13. 지금까지 삶에서 내가 원하는 중요한 것들을 이루었다.',
                          style:
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .emotionQ13Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .emotionQ13Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.emotionQ13Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => EmotionSurveyPage14()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
