...
import 'package:dtxproject/screens/survey_screens/emotion_survey/emotion_survey_page_12.dart';

class EmotionSurveyPage11 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  EmotionSurveyPage11({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .emotionQ11Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .emotionQ11Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.emotionQ11Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => EmotionSurveyPage12()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
