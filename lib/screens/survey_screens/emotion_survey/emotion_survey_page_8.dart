...
import 'package:dtxproject/screens/survey_screens/emotion_survey/emotion_survey_page_9.dart';

class EmotionSurveyPage8 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  EmotionSurveyPage8({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .emotionQ8Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .emotionQ8Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.emotionQ8Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => EmotionSurveyPage9()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
