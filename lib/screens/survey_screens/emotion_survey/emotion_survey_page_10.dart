...
import 'package:dtxproject/screens/survey_screens/emotion_survey/emotion_survey_page_11.dart';

class EmotionSurveyPage10 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  EmotionSurveyPage10({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('10. 대체로 나의 삶은 나의 이상에 가깝다.',
                          style:
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .emotionQ10Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .emotionQ10Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.emotionQ10Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => EmotionSurveyPage11()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
