...
import 'package:dtxproject/screens/survey_screens/emotion_survey/emotion_survey_page_5.dart';

class EmotionSurveyPage4 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  EmotionSurveyPage4({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .emotionQ4Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .emotionQ4Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.emotionQ4Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => EmotionSurveyPage5()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
