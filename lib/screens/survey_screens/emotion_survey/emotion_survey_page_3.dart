...
import 'package:dtxproject/screens/survey_screens/emotion_survey/emotion_survey_page_4.dart';

class EmotionSurveyPage3 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  EmotionSurveyPage3({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('3. 잠들기 어렵거나 자꾸 깨어남, 혹은 너무 많이 잠',
                          style:
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .emotionQ3Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .emotionQ3Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.emotionQ3Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => EmotionSurveyPage4()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
