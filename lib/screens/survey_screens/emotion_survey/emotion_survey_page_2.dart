...
import 'package:dtxproject/screens/survey_screens/emotion_survey/emotion_survey_page_3.dart';

class EmotionSurveyPage2 extends StatelessWidget {
  final surveyController = Get.find<SurveyController>();

  EmotionSurveyPage2({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 80),
                      const Text('2. 가라앉은 느낌, 우울감 혹은 절망감',
                          style:
                                ...
                                return Obx(
                                  () {
                                    ...
                                    bool isSelected = surveyController
                                            .emotionQ2Option.value ==
                                        index;
                                    return GestureDetector(
                                      onTap: () => surveyController
                                          .emotionQ2Option.value = index,
      ...
      bottomNavigationBar: Obx(() {
        bool isButtonEnabled = surveyController.emotionQ2Option.value !=
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: isButtonEnabled
                  ? () {
                      Get.to(() => EmotionSurveyPage3()); // 다음 페이지 이동
                    }
                  : null,
              child: const Text(
                '다음',
